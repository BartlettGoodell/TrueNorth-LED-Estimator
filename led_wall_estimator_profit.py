...
st.markdown(
    ...
    <div class="app-header">
        <img src="https://github.com/BartlettGoodell/TrueNorth-LED-Estimator/blob/main/TrueNorth_Logo.svg"
...
st.markdown("---")
st.caption("Use the 'Tiered (linear 1→25)' mode for vendor-based quotes; adjust RSI % to model your client billing margin.")
